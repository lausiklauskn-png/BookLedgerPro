...
**Kopf-Status (Stand nach „Demo-Vorbefüllung", BAUPLAN Schritt 2d):** SW **v119** · Tests **1444/1444** grün · 115 JS-Module (neu: `domain/demodaten-store.js`).
