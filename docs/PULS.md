...
**Kopf-Status (Stand nach „Angebot → Rechnung-Übernahme", PR #129):** SW **v112** · Tests **1326/1326** grün · 107 JS-Module.
...
**Letzte Aktualisierung:** 2026-06-18 (Angebot → Rechnung-Übernahme) · **Branch (letzte PR):** `claude/quote-to-invoice-transfer-4gvaof` (PR #129)
· **Tests:** `node tests/run.mjs` → **1326/1326 grün**
· **SW-Cache:** `v112` · **107 JS-Module** · **12 Bild- + 5 Icon-Assets** · **Fahrplan V1–V10 ✅ · A (M1–M3) ✅ · B (B1–B3) ✅ · BAUPLAN Block 1 KOMPLETT (Schritt 1 + 2a/2b/2c + 3) · Block 2/Schritt 4 (`rechnungsstelle`) ✅ · Schritt 5 (Kalkulations-Kern) ✅ · Schritt 6 (Produkt-Schemata) ✅ · Schritt 7 (Angebote-Kern) ✅ · Schritt 8 (Angebot → Rechnung-Übernahme) ✅**
· **Mehr-Sitzungs-Plan:** `docs/BAUPLAN.md` (nächste = **Block 2/Schritt 8 — Angebot → Rechnung-Übernahme**).
