...
**Kopf-Status (Stand nach „Adaptiver Baukasten — UI", Schritt 11b):** SW **v116** · Tests **1427/1427** grün · 112 JS-Module (neu: `domain/angebote-store.js` + `ui/views/angebote.js`).
...
**Letzte Aktualisierung:** 2026-06-18 (Adaptiver Baukasten — UI, Schritt 11b) · **Branch (diese PR):** `claude/baukasten-logic-step-11a-cbj8s8`
· **Tests:** `node tests/run.mjs` → **1427/1427 grün**
· **SW-Cache:** `v116` · **112 JS-Module** · **12 Bild- + 5 Icon-Assets** · **Fahrplan V1–V10 ✅ · A (M1–M3) ✅ · B (B1–B3) ✅ · BAUPLAN Block 1 KOMPLETT (Schritt 1 + 2a/2b/2c + 3) · Block 2/Schritt 4 (`rechnungsstelle`) ✅ · Schritt 5 (Kalkulations-Kern) ✅ · Schritt 6 (Produkt-Schemata) ✅ · Schritt 7 (Angebote-Kern) ✅ · Schritt 8 (Angebot → Rechnung-Übernahme, rein) ✅ · Schritt 9 (Auftrags-Kostenträger + Nachkalkulation) ✅ · Schritt 10 (Kalibrierung + Statistik/Vergleich) ✅ · Schritt 11a (Adaptiver Baukasten — reine Logik) ✅ · Schritt 11b (Adaptiver Baukasten — UI: Angebots-Ansicht + Store-Glue) ✅ → Block-2-Kernkette (4–11) komplett**
